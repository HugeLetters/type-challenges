...
type NumToTuple<N extends number, A extends number[] = []> = A['length'] extends N
   ? A
   : NumToTuple<N, [...A, A['length']]>;
type InclusiveRange<Lower extends number, Higher extends number> = NumToTuple<Higher> extends [
   ...NumToTuple<Lower>,
   ...infer R
]
   ? [...R, Higher]
