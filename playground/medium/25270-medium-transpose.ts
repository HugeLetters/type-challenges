...
type FillColumn<Row extends number[], M extends number[][]> = Row extends [
   infer RF,
   ...infer RR extends number[]
]
   ? M extends [infer F extends number[], ...infer R extends number[][]]
      ? [[...F, RF], ...FillColumn<RR, R>]
      : [[RF], ...FillColumn<RR, M>]
   : M;

type Transpose<M extends number[][], N extends number[][] = []> = M extends [
   infer F extends number[],
   ...infer R extends number[][]
]
   ? Transpose<R, FillColumn<F, N>>
   : N;
