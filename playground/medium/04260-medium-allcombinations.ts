...
type UnionizeString<S extends string> = S extends `${infer F}${infer R}` ? F | UnionizeString<R> : S
type AllCombinations<
  S extends string,
  C extends string = UnionizeString<S>,
  U extends string = C
> = C extends C ? `${C}${"" | AllCombinations<S, Exclude<U, C>>}` : never
