...
type Enum<
   ...
   IndexT extends Record<string, any> = {
      [K in keyof T]: K extends `${infer V extends number}` ? V : never;
   }
> = { readonly [K in IndexT[keyof IndexT] as Capitalize<T[K]>]: N extends false ? T[K] : K };
